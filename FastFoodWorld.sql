CREATE DATABASE  IF NOT EXISTS `fastfoodworld` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fastfoodworld`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: fastfoodworld
-- ------------------------------------------------------
...
INSERT INTO `menu_items` VALUES (1,'Pav Bhaji',6.00),(2,'Biryani',7.00),(3,'Samosa',8.00),(4,'Pizza',5.00),(5,'Chole Bhature',6.00),(6,'Vada Pav',9.00);
...
INSERT INTO `orders` VALUES (40,1,2,12.00),(40,3,1,8.00),(41,4,3,15.00),(41,6,2,18.00),(41,5,4,20.00);
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'fastfoodworld'
--
...
BEGIN
    ...
    SET v_item_id = (SELECT item_id FROM menu_items WHERE name = p_food_item);
